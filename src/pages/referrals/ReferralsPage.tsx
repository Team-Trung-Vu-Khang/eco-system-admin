...
export function ReferralsPage() {
  ...
  const [detailReferral, setDetailReferral] = useState<ReferralRow | null>(null);
    ...
    <section className="space-y-6 rounded-3xl border border-black/5 bg-white/80 p-5 shadow-[0_24px_80px_rgba(15,23,42,0.08)] backdrop-blur md:p-8">
      ...
      <Dialog open={detailOpen} onOpenChange={setDetailOpen}>
        <DialogContent className="overflow-hidden p-0 sm:max-w-2xl">
          {detailReferral ? (
            <div className="bg-gradient-to-br from-amber-50 via-white to-sky-50">
                ...
                <DialogHeader className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <DialogDescription className="text-sm leading-6 text-slate-500">
                      Thông tin người giới thiệu được chuẩn hóa theo số điện thoại đầu
                      <code>84</code>.
                    </DialogDescription>
                  </div>
